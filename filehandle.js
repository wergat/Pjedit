   ...
   if(typ=="object"){
    if((typeof (array[key].length)) != "undefined"){
	 ...
	 if(upperKeyName=="anchors"){
      ...
      $id('terrainsData').innerHTML = $id('terrainsData').innerHTML + "<div>#"+key+"</a> w/ type "+array[key]["terrainType"]+" ("+array[key]["layoutName"]+") at (<input id='terrainsInputX"+key+"' type='text' name='"+key+"' value='"+array[key]["pos"]["x"]+"'>/<input id='terrainsInputY"+key+"' type='text' name='"+key+"' value='"+array[key]["pos"]["y"]+"'>)</div>"		 
